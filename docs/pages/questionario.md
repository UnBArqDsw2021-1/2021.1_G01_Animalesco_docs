...
O uso de questionários é uma das técnicas de coletas de dados mais frequentemente utilizadas. Um questionário é um formulário impresso ou digital com perguntas que os usuários ou grupo de foco devem responder, com a finalidade de fornecer dados necessários para um futura análise. Diferentemente das demais técnicas, questionários permitem coletar dados de um grande número de pessoas, mesmo que geograficamente dispersas, resultado assim em amostras muito maiores. [1]

A utilização da técnica de questionários para a elicitação de requisitos, de acordo com Courage e Baxter, tem como objetivo principal a coleta rápida de dados de muitos usuários, principalmente dados quantitativos. Essa técnica tem como principal vantagem a capacidade de coletar informações de muitos usuários com um custo relativamente barato, quando comparado com as demais técnicas (entrevistas, grupos de focos, estudo de campos e outras). Porém, por mais que o uso dessa técnica seja simples, é necessário experiência do elaborador e avaliador do questionário, para que seja evitado perguntas ambíguas e dinâmicas que induzam respostas. [1] [2]

Questionários de elicitação de requisitos podem conter perguntas abertas e fechadas, mas geralmente as perguntas fechadas são mais utilizadas por serem de rápido preenchimento e por viabilizar análise estatística. [1] 

Uma característica dos questionários é sua "assincronicidade", o grupo alvo do questionário pode respondê-lo no seu próprio tempo e no conforto do seu ambiente, sem a necessidade de combinar datas e horário de encontro, e sem a necessidade de se deslocar para um local ou ingressar em uma chamada de vídeo/audio. No entanto essa característica também pode ser desvantagem, pois a pessoa que estiver respondendo o questionário não terá como tirar dúvidas sobre as perguntas, estando sujeita a interpretações erradas. Dessa forma, a elaboração do questionário deve ser cuidadosa e deve-se evitar ao máximo ambiguidades e mal-entendidos (Lazar el.al., 2010).

## 2. Metodologia

O uso da técnica de questionário surgiu da necessidade de se conhecer melhor o nosso público alvo. Dessa forma, os integrantes do grupo se reuniu durante o dia 30 de julho de 2021 e discutiu quais eram as informações interessantes que o grupo gostaria de saber sobre seus usuários. Após essa dinâmica de brainstorming, as seguintes questões surgiram:
...
Uma vez que as perguntas principais que o grupo estava interessado em saber foram definidas, foi utilizado a ferramenta Google Forms para elaborar um questionário. Essa ferramenta permite a criação de questionário com diversos tipos de perguntas (múltiplas escolhas, faixa de valores, escalas, perguntas abertas, etc.), além de criar gráficos dinâmicos que facilitam a análise posterior.


Após a conclusão do formulário, foi contabilizado 16 perguntas, no seguinte fluxo:
...
### 4.2 Análise das perguntas e elicitação de requisitos
...
| ID   | Requisito | 
|:-:   | :-: |  
| RF02 | Adicionar local do banho |
| RF03 | Histórico de banho |
| RF04 | Histórico de vacinação |
| RF05 | Agenda de vacinação |
| RF06 | Histórico de medicação |
| RF07 | Histórico de consultas |
| RF08 | Lembrete de medicamento de uso contínuo |
| RF09 | Agenda de medicamento |
...
[2] Courage, Catherine; Baxter, Kathy; Caine, Kelly. Understanding Your Users: A Practical Guide to User
